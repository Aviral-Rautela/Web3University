...
import { idlFactory } from './web3University_frontend.did.js';
export { idlFactory } from './web3University_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEB3UNIVERSITY_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web3University_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web3University_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web3University_frontend.did.js")._SERVICE>}
 */
export const web3University_frontend = createActor(canisterId);
